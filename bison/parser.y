...
%%
    ...
    LARTHRO:    ARS_EN_AR           { $<arthro>$ = yylval.arthro;               printf("%s (", yylval.arthro); printf(a_c_m italic bold"οριστικό άρθρο γένους αρσσενικό, ενικού" italic_re);       printf(") "); }
                ...
                |THY_EN_AR          { $<arthro>$ = yylval.arthro;               printf("%s (", yylval.arthro); printf(a_c_m italic bold"οριστικό άρθρο γένους θηλυκό, ενικού" italic_re);          printf(") "); }
                |THY_PL_AR          { $<arthro>$ = yylval.arthro;               printf("%s (", yylval.arthro); printf(a_c_m italic bold"οριστικό άρθρο γένους θηλυκό, πληθυντικού" italic_re);     printf(") "); }

                |OUD_EN_AR          { $<arthro>$ = yylval.arthro;               printf("%s (", yylval.arthro); printf(a_c_m italic bold"οριστικό άρθρο γένους ουδέτερο ενικού" italic_re);        printf(") "); }
                |OUD_PL_AR          { $<arthro>$ = yylval.arthro;               printf("%s (", yylval.arthro); printf(a_c_m italic bold"οριστικό άρθρο γένους ουδέτερο πληθυντικού" italic_re);   printf(") "); }

                |_EN_AR             { $<arthro>$ = yylval.arthro;               printf("%s (", yylval.arthro); printf(a_c_m italic bold"οριστικό άρθρο γένους αγνώστου ενικού" italic_re);         printf(") "); }
                |_PL_AR             { $<arthro>$ = yylval.arthro;               printf("%s (", yylval.arthro); printf(a_c_m italic bold"οριστικό άρθρο γένους αγνώστου πληθυντικού" italic_re);    printf(") "); }
